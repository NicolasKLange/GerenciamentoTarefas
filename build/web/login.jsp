    ...
    <body>
        <article>
            ...
            <form action="VerificarUsuario.jsp">
                <!-- Verificar usuário para fazer o login -->
                ...
                <!-- Botão para abrir o modal para redefinir senha-->
        ...
        <dialog id="modalRedefinirSenha" class="modal">
            <div class="modal-content">
                ...
                <form action="redefinirSenha.jsp" method="POST">
                    ...
                    <!-- Botão para cancelar a redefinição da senha -->
                    <button type="submit" onclick="window.location.href = 'login.jsp'">Cancelar</button>
                </form>
            </div>
        </dialog>
        <!-- Script para manipular o modal de redefinir senha -->
        <script src="js/modal.js"></script>
    </body>
</html>
<style>

    /* Style para o modal de redefinir senha*/
    .modal {
